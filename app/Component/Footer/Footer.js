...
export default function Footer({style}){
    ...
    const address = [
        {
            location: 'Hyderabad',
            description: 'Plot 219, D 8-2-293/82 Road Number 78, Jubilee Hills, Hyderabad, Telangana, 500033',
    ...
    return(
        <footer className="footer" style={{position:'relative', background: '#FFF'}}>
            ...
            >
                ...
                >
                    {/* Map items here */}
                    {address.map(({location, href, description}) => (    
                        <div
                        ...
                        >
                            ...
                            <p className="footer-texts address-description haffer-R">
                                {description}
                            </p>
                            <a 
                            ...
                            >
                                View directions <div className="footer-arrow"><Arrow /></div>
                            </a>
                        </div>
                    ))}
                </div>
